...
function getSum(ary){
  ...
  return (
    ...
    <p style={{fontSize:'20px'}} className="checkout-heading">How you would like to recieve your order?</p>
      ...
      <p style={{fontSize:'18px', marginTop:'15px'}} className="checkout-heading">**NOTE: We do not deliver outside of the city limits of PAMPA. If you are outside of the city limits, your order will be canceled and refunded promptly.**</p>
